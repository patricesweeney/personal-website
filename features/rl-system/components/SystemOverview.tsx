    ...
    <section className="section" style={{ paddingTop: "var(--space-6)" }}>
      ...
      <div className="grid grid-12">
        <div className="span-12">
          <p>
            A SaaS business is a control loop where the company repeatedly acts under uncertainty about the true world. The environment has a hidden state <InlineMath math="s_t" /> (the actual situation of the world at time <InlineMath math="t" />, not directly seen), the company chooses an action <InlineMath math="a_t" /> (an intervention it can take), the environment returns a reward <InlineMath math="r_t" /> (a scalar feedback signal encoding how good that outcome was under the company's objective), and the company receives an observation <InlineMath math="o_t" /> (a noisy, partial measurement generated from the hidden state). Market dynamics specify how actions change states <InlineMath math="P(s_{t+1} \mid s_t, a_t)" /> and how states generate observations <InlineMath math="P(o_t \mid s_t)" />, so the company maintains a belief over states and selects actions to maximize expected cumulative reward.
          </p>
